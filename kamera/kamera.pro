...
UBUNTU_TRANSLATION_DOMAIN="kamera.username"
...
aptest.commands = bash $$PWD/kamera/tests/autopilot/run
aptest.depends  = sub-kamera

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/kamera/tests/unit 
unittest.depends  = sub-kamera
